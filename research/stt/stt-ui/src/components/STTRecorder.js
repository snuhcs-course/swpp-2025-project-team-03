  ...
  const processWholeAudioWithTimestamps = async (audioBlob) => {
    try {
      ...
      const response = await axios.post(
        "http://localhost:5000/api/google-speech",
        formData,
        {
          headers: {
  ...
  return (
    <div className="stt-recorder">
      ...
      <div className="instructions">
        ...
        <ol>
          <li>
            🎤 <strong>녹음 시작</strong> 버튼을 클릭하세요
          </li>
          <li>🗣️ 마이크에 대고 명확하게 말씀하세요</li>
          <li>
            ⏹️ <strong>녹음 중지</strong> 버튼을 클릭하세요
          </li>
          <li>
            🎯 <strong>Google STT</strong>로 단어별 타임스탬프와 함께 변환됩니다
          </li>
